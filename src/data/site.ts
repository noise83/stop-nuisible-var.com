...
export const guides: Guide[] = [
  ...
  },
  {
    ...
    sections: [],
    illustratedGuide: {
      h1: "Quel nuisible ai-je ? Identifier les signes observés dans le Var",
      introduction:
        "Vous entendez un bruit, trouvez une déjection, constatez une piqûre, une trace ou un dégât, apercevez un insecte, un nid ou une activité de vol ? Partez de ce que vous observez pour comparer les signes déjà couverts par ce guide et mieux orienter votre demande, sans diagnostic certain à distance.",
      ...
      summary: [
        { label: "Bruit ou déjections — rats et souris", href: "#rats-souris" },
        { label: "Insecte aperçu — cafards et blattes", href: "#cafards-blattes" },
        { label: "Piqûres ou traces — punaises de lit", href: "#punaises-lit" },
        { label: "Nid ou activité de vol — guêpes et frelons", href: "#guepes-frelons" },
        { label: "Dégâts du bois — termites et xylophages", href: "#termites-xylophages" },
        { label: "Piqûres dehors — moustique tigre", href: "#moustique-tigre" },
        { label: "Extérieur ou jardin — chenilles processionnaires", href: "#chenilles-processionnaires" },
        { label: "Traces sur balcon ou toiture — pigeons et goélands", href: "#pigeons-goelands" },
