...
function IllustratedGuidePage({
  ...
  if (!content) notFound();
  const mobileContainerStyle = { maxWidth: "calc(100vw - 32px)" };
  ...
  return (
    <main>
      ...
      <Section className="py-10 sm:py-18">
        <div className="container grid gap-8 lg:max-w-[1160px] lg:grid-cols-[1fr_360px] lg:items-start" style={mobileContainerStyle}>
      ...
      <Section tone="white" className="py-10 sm:py-16">
        <div className="container grid gap-8 lg:max-w-[1160px] lg:grid-cols-[260px_1fr] lg:items-start" style={mobileContainerStyle}>
      ...
      <Section className="py-10 sm:py-16">
        <div id="photo" className="container grid gap-8 lg:max-w-[1160px] lg:grid-cols-[.9fr_1.1fr] lg:items-center" style={mobileContainerStyle}>
          <Image
      ...
      <Section tone="white" className="py-10 sm:py-16">
        <div className="container grid gap-8 lg:max-w-[1160px] lg:grid-cols-[1fr_360px]" style={mobileContainerStyle}>
          <article>
      ...
      <Section className="py-10 sm:py-16">
        <div className="container grid gap-8 lg:max-w-[1160px] lg:grid-cols-[.9fr_1.1fr]" style={mobileContainerStyle}>
          <div>
      ...
      <Section tone="white" className="py-10 sm:py-16">
        <div className="container lg:max-w-3xl" style={mobileContainerStyle}>
      ...
      <section className="bg-[#102337] py-12 text-white sm:py-16">
        <div className="container flex flex-col justify-between gap-6 md:flex-row md:items-center lg:max-w-[1160px]" style={mobileContainerStyle}>
          <div>
